...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns4="urn:eway:document-schemas:export-wml-project">
  <xsl:output method="xml" encoding="UTF-8" standalone="yes" />
  <xsl:template match="/">
    <xsl:processing-instruction name="mso-application">
      <xsl:text>progid="Word.Document"</xsl:text>
    </xsl:processing-instruction>
    <w:wordDocument xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns4="urn:eway:document-schemas:export-wml-project" w:macrosPresent="no" w:embeddedObjPresent="no" w:ocxPresent="no" xml:space="preserve">
      ...
      <w:docPr>
        ...
        <w:footnotePr>
          <w:footnote w:type="separator">
            <w:p wsp:rsidR="006F6DFD" wsp:rsidRDefault="006F6DFD">
              <w:r>
                <w:separator />
              </w:r>
            </w:p>
        ...
        <wsp:rsids>
          <wsp:rsidRoot wsp:val="00B73A81" />
          <wsp:rsid wsp:val="002105D8" />
          <wsp:rsid wsp:val="00687395" />
          <wsp:rsid wsp:val="006F6DFD" />
          <wsp:rsid wsp:val="007A195E" />
          <wsp:rsid wsp:val="00933F48" />
          <wsp:rsid wsp:val="00947A59" />
          <wsp:rsid wsp:val="009B6FE0" />
          <wsp:rsid wsp:val="009E2E53" />
          <wsp:rsid wsp:val="00A723CD" />
          <wsp:rsid wsp:val="00B438F7" />
          <wsp:rsid wsp:val="00B73A81" />
      ...
      <w:body>
        <wx:sect>
          <xsl:apply-templates select="ns4:Project" />
          <w:sectPr wsp:rsidR="00B73A81" wsp:rsidSect="00B73A81">
            <w:ftr w:type="odd">
              <wx:pBdrGroup>
                <wx:borders>
                  <wx:top wx:val="solid" wx:bdrwidth="10" wx:space="1" wx:color="BFBFBF" />
                </wx:borders>
                <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
                  <w:pPr>
                    <w:pStyle w:val="Zpat" />
                    <w:pBdr>
  ...
  <xsl:template match="/ns4:Project">
    <ns4:Project>
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00A723CD">
        <w:pPr>
          <w:jc w:val="right" />
          <w:rPr>
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:ProjectName" />
      </w:p>
      <w:tbl>
        <w:tblPr>
        ...
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          <w:trPr>
        ...
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          ...
          <w:tc>
            ...
            <xsl:apply-templates select="ns4:MyCompany[1]" />
          </w:tc>
          <w:tc>
            <w:tcPr>
              <w:tcW w:w="4920" w:type="dxa" />
            ...
            <xsl:apply-templates select="ns4:Customer[1]" />
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          <w:trPr>
          ...
          <w:tc>
            ...
            <xsl:apply-templates select="ns4:Supervisor" />
          </w:tc>
          <w:tc>
            <w:tcPr>
              <w:tcW w:w="4920" w:type="dxa" />
            ...
            <xsl:apply-templates select="ns4:ContactPerson" />
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          <w:trPr>
          ...
          <w:tc>
            ...
            <xsl:apply-templates select="ns4:MyCompany[2]" />
          </w:tc>
          <w:tc>
            <w:tcPr>
              <w:tcW w:w="4920" w:type="dxa" />
            ...
            <xsl:apply-templates select="ns4:Customer[2]" />
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          <w:trPr>
          ...
          <w:tc>
            ...
            <xsl:apply-templates select="ns4:MyCompany[position() &gt;= 3]" />
          </w:tc>
          <w:tc>
            <w:tcPr>
              <w:tcW w:w="4920" w:type="dxa" />
            ...
            <xsl:apply-templates select="ns4:Customer[position() &gt;= 3]" />
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          <w:trPr>
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00B73A81">
              <w:pPr>
                <w:ind w:left="119" />
                <w:rPr>
                  <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00A723CD">
              ...
              <w:r>
                ...
                <w:tab wx:wTab="375" wx:tlc="none" wx:cTlc="5" />
              </w:r>
            </w:p>
          </w:tc>
          <w:tc>
            ...
            <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
              ...
              <xsl:apply-templates select="ns4:HID" />
            </w:p>
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
              ...
              <xsl:apply-templates select="ns4:ProjectStart" />
            </w:p>
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00B73A81" wsp:rsidTr="002105D8">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
              ...
              <xsl:apply-templates select="ns4:ProjectEnd" />
            </w:p>
          </w:tc>
        </w:tr>
      </w:tbl>
  ...
  <xsl:template match="/ns4:Project/ns4:ProjectName">
    <ns4:ProjectName>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:ContactPerson">
    <ns4:ContactPerson>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:ContactPerson/ns4:FileAs">
    <ns4:FileAs>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Supervisor">
    <ns4:Supervisor>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Supervisor/ns4:FileAs">
    <ns4:FileAs>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Customer[1]">
    <ns4:Customer>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:CompanyName" />
      </w:p>
    </ns4:Customer>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:Customer[1]/ns4:CompanyName">
    <ns4:CompanyName>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Customer[2]">
    <ns4:Customer>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:Address1Street" />
      </w:p>
    </ns4:Customer>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:Customer[2]/ns4:Address1Street">
    <ns4:Address1Street>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Customer[position() &gt;= 3]">
    <ns4:Customer>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:Address1PostalCode" />
        <w:r wsp:rsidR="00A723CD">
          <w:rPr>
            <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
            <wx:font wx:val="Segoe UI" />
        ...
        <xsl:apply-templates select="ns4:Address1City" />
        <w:r wsp:rsidR="002105D8">
          <w:rPr>
            <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
            <wx:font wx:val="Segoe UI" />
            <w:color w:val="414042" />
        ...
        <xsl:apply-templates select="ns4:Address1State" />
      </w:p>
    </ns4:Customer>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:Customer[position() &gt;= 3]/ns4:Address1City">
    <ns4:Address1City>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:Customer[position() &gt;= 3]/ns4:Address1PostalCode">
    <ns4:Address1PostalCode>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
        </xsl:attribute>
  ...
  <xsl:template match="/ns4:Project/ns4:Customer[position() &gt;= 3]/ns4:Address1State">
    <ns4:Address1State>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:ProjectEnd">
    <ns4:ProjectEnd>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:MyCompany[1]">
    <ns4:MyCompany>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:MyCompanyName" />
      </w:p>
    </ns4:MyCompany>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:MyCompany[1]/ns4:MyCompanyName">
    <ns4:MyCompanyName>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:MyCompany[2]">
    <ns4:MyCompany>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:MyCompanyStreet" />
      </w:p>
    </ns4:MyCompany>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:MyCompany[2]/ns4:MyCompanyStreet">
    <ns4:MyCompanyStreet>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:MyCompany[position() &gt;= 3]">
    <ns4:MyCompany>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:p wsp:rsidR="00B73A81" wsp:rsidRDefault="00933F48">
        ...
        <xsl:apply-templates select="ns4:MyCompanyZip" />
        <w:r wsp:rsidR="00A723CD">
          <w:rPr>
            <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
            <wx:font wx:val="Segoe UI" />
        ...
        <xsl:apply-templates select="ns4:MyCompanyCity" />
        <w:r wsp:rsidR="002105D8">
          <w:rPr>
            <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
            <wx:font wx:val="Segoe UI" />
        ...
        <xsl:apply-templates select="ns4:MyCompanyState" />
      </w:p>
    </ns4:MyCompany>
  </xsl:template>
  <xsl:template match="/ns4:Project/ns4:MyCompany[position() &gt;= 3]/ns4:MyCompanyState">
    <ns4:MyCompanyState>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:MyCompany[position() &gt;= 3]/ns4:MyCompanyCity">
    <ns4:MyCompanyCity>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:MyCompany[position() &gt;= 3]/ns4:MyCompanyZip">
    <ns4:MyCompanyZip>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:ProjectStart">
    <ns4:ProjectStart>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns4:Project/ns4:HID">
    <ns4:HID>
      <xsl:for-each select="@ns4:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
