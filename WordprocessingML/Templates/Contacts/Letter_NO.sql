...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns2="urn:eway:document-schemas:export-wml-contact">
  <xsl:output method="xml" encoding="UTF-8" standalone="yes" />
  <xsl:template match="/">
    <xsl:processing-instruction name="mso-application">
      <xsl:text>progid="Word.Document"</xsl:text>
    </xsl:processing-instruction>
    <w:wordDocument xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns2="urn:eway:document-schemas:export-wml-contact" w:macrosPresent="no" w:embeddedObjPresent="no" w:ocxPresent="no" xml:space="preserve">
      ...
      <o:DocumentProperties>
        ...
        <o:Created>2020-08-12T06:20:00Z</o:Created>
        <o:LastSaved>2020-09-29T12:12:00Z</o:LastSaved>
        <o:Pages>1</o:Pages>
        <o:Words>29</o:Words>
      ...
      <w:docPr>
        ...
        <w:footnotePr>
          <w:footnote w:type="separator">
            <w:p wsp:rsidR="00FA1555" wsp:rsidRDefault="00FA1555">
              <w:r>
                <w:separator />
              </w:r>
            </w:p>
        ...
        <wsp:rsids>
          <wsp:rsidRoot wsp:val="00D0535E" />
          <wsp:rsid wsp:val="00112FA9" />
          <wsp:rsid wsp:val="00146B38" />
          <wsp:rsid wsp:val="003840C7" />
          <wsp:rsid wsp:val="0047713A" />
          <wsp:rsid wsp:val="00854E61" />
          <wsp:rsid wsp:val="00A01F1B" />
          <wsp:rsid wsp:val="00B1297A" />
          <wsp:rsid wsp:val="00C26F0E" />
          <wsp:rsid wsp:val="00D0535E" />
          <wsp:rsid wsp:val="00E00807" />
          <wsp:rsid wsp:val="00FA1555" />
        </wsp:rsids>
      ...
      <w:body>
        <wx:sect>
          ...
          <w:sectPr wsp:rsidR="00D0535E" wsp:rsidSect="00D0535E">
            <w:ftr w:type="odd">
              <wx:pBdrGroup>
                <wx:borders>
                  <wx:top wx:val="solid" wx:bdrwidth="10" wx:space="1" wx:color="BFBFBF" />
                </wx:borders>
                <w:p wsp:rsidR="00A01F1B" wsp:rsidRDefault="00A01F1B" wsp:rsidP="00A01F1B">
                  <w:pPr>
                    <w:pStyle w:val="Zpat" />
                    <w:pBdr>
  ...
  <xsl:template match="/ns2:Contact">
    <ns2:Contact>
      ...
      <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00146B38">
        <w:pPr>
      ...
      <w:tbl>
        ...
        <w:tr wsp:rsidR="00D0535E" wsp:rsidTr="00E00807">
          <w:trPr>
            ...
            <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00146B38">
              ...
              <w:r>
                <w:rPr>
                  ...
                  <w:sz-cs w:val="22" />
                  <w:lang w:val="CS" />
                </w:rPr> <w:t><xsl:text>Avsender</xsl:text></w:t></w:r>
            </w:p>
          </w:tc>
          <w:tc>
            <w:tcPr>
        ...
        <w:tr wsp:rsidR="00D0535E" wsp:rsidTr="00E00807">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00B1297A">
              <w:pPr>
                <w:ind w:left="120" />
                <w:rPr>
        ...
        <w:tr wsp:rsidR="00D0535E" wsp:rsidTr="00E00807">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00B1297A">
              ...
              <xsl:apply-templates select="ns2:BusinessAddressStreet" />
            </w:p>
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00D0535E" wsp:rsidTr="00E00807">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00B1297A">
              ...
              <xsl:apply-templates select="ns2:BusinessAddressPostalCode" />
              <w:r wsp:rsidR="00146B38">
                <w:rPr>
                  <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
                  <wx:font wx:val="Segoe UI" />
              ...
              <xsl:apply-templates select="ns2:BusinessAddressCity" />
            </w:p>
          </w:tc>
        </w:tr>
      </w:tbl>
      <w:p wsp:rsidR="00D0535E" wsp:rsidRDefault="00D0535E">
        <w:pPr>
          <w:rPr>
            <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
            <wx:font wx:val="Segoe UI" />
  ...
  <xsl:template match="/ns2:Contact/ns2:BusinessAddressPostalCode">
    <ns2:BusinessAddressPostalCode>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
        </xsl:attribute>
  ...
  <xsl:template match="/ns2:Contact/ns2:Company">
    <ns2:Company>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:Company/ns2:CompanyName">
    <ns2:CompanyName>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[1]">
    <ns2:MyCompany>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[1]/ns2:MyCompanyName">
    <ns2:MyCompanyName>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[2]">
    <ns2:MyCompany>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[2]/ns2:MyCompanyStreet">
    <ns2:MyCompanyStreet>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[position() &gt;= 3]">
    <ns2:MyCompany>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[position() &gt;= 3]/ns2:MyCompanyZip">
    <ns2:MyCompanyZip>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:MyCompany[position() &gt;= 3]/ns2:MyCompanyCity">
    <ns2:MyCompanyCity>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:CurrentUser">
    <ns2:CurrentUser>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns2:Contact/ns2:CurrentUser/ns2:FileAs">
    <ns2:FileAs>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
      ...
      <w:r wsp:rsidR="00146B38" wsp:rsidRPr="003840C7">
        <w:rPr>
          <w:rFonts w:ascii="Segoe UI Semibold" w:h-ansi="Segoe UI Semibold" w:cs="Segoe UI Semibold" />
          <wx:font wx:val="Segoe UI Semibold" />
          <w:color w:val="414042" />
  ...
  <xsl:template match="/ns2:Contact/ns2:BusinessAddressCity">
    <ns2:BusinessAddressCity>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
        </xsl:attribute>
  ...
  <xsl:template match="/ns2:Contact/ns2:BusinessAddressStreet">
    <ns2:BusinessAddressStreet>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
        </xsl:attribute>
  ...
  <xsl:template match="/ns2:Contact/ns2:FileAs">
    <ns2:FileAs>
      <xsl:for-each select="@ns2:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
