...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns3="urn:eway:document-schemas:proposal-base2">
  ...
  <xsl:template match="/">
    ...
    <w:wordDocument xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns3="urn:eway:document-schemas:proposal-base2" w:macrosPresent="no" w:embeddedObjPresent="no" w:ocxPresent="no" xml:space="preserve">
      ...
      <o:DocumentProperties>
        ...
        <o:Created>2020-08-11T05:31:00Z</o:Created>
      ...
      <w:docPr>
        ...
        <w:footnotePr>
          <w:footnote w:type="separator">
            <w:p wsp:rsidR="006B7A24" wsp:rsidRDefault="006B7A24">
              <w:r>
                <w:separator />
              </w:r>
            </w:p>
        ...
        <wsp:rsids>
          <wsp:rsidRoot wsp:val="00A467F7" />
          <wsp:rsid wsp:val="001B5554" />
          <wsp:rsid wsp:val="001E3CF3" />
          <wsp:rsid wsp:val="00666FEC" />
          <wsp:rsid wsp:val="00691286" />
          <wsp:rsid wsp:val="006B7A24" />
          <wsp:rsid wsp:val="00886E8D" />
          <wsp:rsid wsp:val="009C1C56" />
          <wsp:rsid wsp:val="00A467F7" />
          <wsp:rsid wsp:val="00B438F7" />
          <wsp:rsid wsp:val="00B807D1" />
          <wsp:rsid wsp:val="00D55B4D" />
          <wsp:rsid wsp:val="00FC2ECE" />
        </wsp:rsids>
      ...
      <w:body>
        <wx:sect>
          ...
          <w:sectPr wsp:rsidR="00A467F7" wsp:rsidSect="00A467F7">
            <w:ftr w:type="odd">
              <wx:pBdrGroup>
                <wx:borders>
                  <wx:top wx:val="solid" wx:bdrwidth="10" wx:space="1" wx:color="BFBFBF" />
                </wx:borders>
                <w:p wsp:rsidR="00A467F7" wsp:rsidRDefault="00B807D1">
                  <w:pPr>
                    <w:pStyle w:val="Zpat" />
                    <w:pBdr>
              ...
              <w:p wsp:rsidR="00A467F7" wsp:rsidRDefault="00A467F7" />
            </w:ftr>
  ...
  <xsl:template match="/ns3:Proposal">
    <ns3:Proposal>
      ...
      <w:p wsp:rsidR="00A467F7" wsp:rsidRDefault="00691286">
        <w:pPr>
          <w:jc w:val="right" />
          <w:rPr>
      ...
      <w:tbl>
        ...
        <w:tr wsp:rsidR="00A467F7" wsp:rsidTr="009C1C56">
          <w:trPr>
        ...
        <w:tr wsp:rsidR="00A467F7">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00A467F7" wsp:rsidRDefault="00B807D1">
              ...
              <xsl:apply-templates select="ns3:CurrencyEn" />
            </w:p>
          </w:tc>
        </w:tr>
      </w:tbl>
  ...
  <xsl:template match="/ns3:Proposal/ns3:PriceTotalExcludingVAT">
  ...
  <xsl:template match="/ns3:Proposal/ns3:Goods/ns3:Item/ns3:PriceTotalExcludingVAT">
    <ns3:PriceTotalExcludingVAT>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:MyCompany[position() &gt;= 3]">
    <ns3:MyCompany>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:MyCompany[position() &gt;= 3]/ns3:MyCompanyCity">
    <ns3:MyCompanyCity>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:MyCompany[position() &gt;= 3]/ns3:MyCompanyState">
    <ns3:MyCompanyState>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:MyCompany[position() &gt;= 3]/ns3:MyCompanyZip">
    <ns3:MyCompanyZip>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:CurrencyEn">
    <ns3:CurrencyEn>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:Customer[position() &gt;= 3]">
    <ns3:Customer>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:Customer[position() &gt;= 3]/ns3:Address1PostalCode">
  ...
  <xsl:template match="/ns3:Proposal/ns3:Customer[position() &gt;= 3]/ns3:Address1State">
    <ns3:Address1State>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Proposal/ns3:Customer[position() &gt;= 3]/ns3:Address1City">
    <ns3:Address1City>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
