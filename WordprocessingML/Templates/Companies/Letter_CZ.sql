...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns3="urn:eway:document-schemas:export-wml-company">
  <xsl:output method="xml" encoding="UTF-8" standalone="yes" />
  <xsl:template match="/">
    <xsl:processing-instruction name="mso-application">
      <xsl:text>progid="Word.Document"</xsl:text>
    </xsl:processing-instruction>
    <w:wordDocument xmlns:w="http://schemas.microsoft.com/office/word/2003/wordml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w10="urn:schemas-microsoft-com:office:word" xmlns:sl="http://schemas.microsoft.com/schemaLibrary/2003/core" xmlns:aml="http://schemas.microsoft.com/aml/2001/core" xmlns:wx="http://schemas.microsoft.com/office/word/2003/auxHint" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:dt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882" xmlns:wsp="http://schemas.microsoft.com/office/word/2003/wordml/sp2" xmlns:ns0="http://schemas.microsoft.com/office/word/2010/wordprocessingCanvas" xmlns:ns1="http://schemas.microsoft.com/office/word/2006/wordml" xmlns:ns3="urn:eway:document-schemas:export-wml-company" w:macrosPresent="no" w:embeddedObjPresent="no" w:ocxPresent="no" xml:space="preserve">
      ...
      <o:DocumentProperties>
        ...
        <o:LastSaved>2020-09-30T06:06:00Z</o:LastSaved>
        <o:Pages>1</o:Pages>
        <o:Words>27</o:Words>
      ...
      <w:docPr>
        ...
        <w:footnotePr>
          <w:footnote w:type="separator">
            <w:p wsp:rsidR="00592A95" wsp:rsidRDefault="00592A95">
              <w:r>
                <w:separator />
              </w:r>
            </w:p>
        ...
        <wsp:rsids>
          <wsp:rsidRoot wsp:val="00644D7E" />
          <wsp:rsid wsp:val="00092C8A" />
          <wsp:rsid wsp:val="00093D85" />
          <wsp:rsid wsp:val="001E6D3A" />
          <wsp:rsid wsp:val="0047713A" />
          <wsp:rsid wsp:val="00537235" />
          <wsp:rsid wsp:val="00592A95" />
          <wsp:rsid wsp:val="005F2B18" />
          <wsp:rsid wsp:val="00644D7E" />
          <wsp:rsid wsp:val="00AE3F79" />
          <wsp:rsid wsp:val="00C87376" />
          <wsp:rsid wsp:val="00DD3E42" />
          <wsp:rsid wsp:val="00DF0F35" />
        </wsp:rsids>
      ...
      <w:body>
        <wx:sect>
          ...
          <w:sectPr wsp:rsidR="00644D7E" wsp:rsidSect="00644D7E">
            <w:ftr w:type="odd">
              <wx:pBdrGroup>
                <wx:borders>
                  <wx:top wx:val="solid" wx:bdrwidth="10" wx:space="1" wx:color="BFBFBF" />
                </wx:borders>
                <w:p wsp:rsidR="005F2B18" wsp:rsidRDefault="00C87376" wsp:rsidP="005F2B18">
                  <w:pPr>
                    <w:pStyle w:val="Zpat" />
                    <w:pBdr>
  ...
  <xsl:template match="/ns3:Company">
    <ns3:Company>
      ...
      <w:p wsp:rsidR="00644D7E" wsp:rsidRDefault="00DD3E42">
        <w:pPr>
      ...
      <w:tbl>
        ...
        <w:tr wsp:rsidR="00644D7E" wsp:rsidTr="00DF0F35">
          <w:trPr>
        ...
        <w:tr wsp:rsidR="00644D7E" wsp:rsidTr="00DF0F35">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00644D7E" wsp:rsidRDefault="00C87376">
              <w:pPr>
                <w:ind w:left="120" />
                <w:rPr>
        ...
        <w:tr wsp:rsidR="00644D7E" wsp:rsidTr="00DF0F35">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00644D7E" wsp:rsidRDefault="00644D7E">
              <w:pPr>
                <w:ind w:left="120" />
                <w:rPr>
                  <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
        ...
        <w:tr wsp:rsidR="00644D7E" wsp:rsidTr="00DF0F35">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00644D7E" wsp:rsidRDefault="00C87376">
              ...
              <xsl:apply-templates select="ns3:Address2Street" />
            </w:p>
          </w:tc>
        </w:tr>
        <w:tr wsp:rsidR="00644D7E" wsp:rsidTr="00DF0F35">
          ...
          <w:tc>
            ...
            <w:p wsp:rsidR="00644D7E" wsp:rsidRDefault="00C87376">
              ...
              <xsl:apply-templates select="ns3:Address2PostalCode" />
              <w:r wsp:rsidR="00DD3E42">
                <w:rPr>
                  <w:rFonts w:ascii="Segoe UI" w:h-ansi="Segoe UI" w:cs="Segoe UI" />
                  <wx:font wx:val="Segoe UI" />
                  <w:color w:val="414042" />
              ...
              <xsl:apply-templates select="ns3:Address2City" />
            </w:p>
          </w:tc>
        </w:tr>
      </w:tbl>
  ...
  <xsl:template match="/ns3:Company/ns3:Address2PostalCode">
    <ns3:Address2PostalCode>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
        </xsl:attribute>
  ...
  <xsl:template match="/ns3:Company/ns3:Address2City">
    <ns3:Address2City>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:CompanyName">
    <ns3:CompanyName>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[1]">
    <ns3:MyCompany>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[1]/ns3:MyCompanyName">
    <ns3:MyCompanyName>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[2]">
    <ns3:MyCompany>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[2]/ns3:MyCompanyStreet">
    <ns3:MyCompanyStreet>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[position() &gt;= 3]">
    <ns3:MyCompany>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[position() &gt;= 3]/ns3:MyCompanyCity">
    <ns3:MyCompanyCity>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:MyCompany[position() &gt;= 3]/ns3:MyCompanyZip">
    <ns3:MyCompanyZip>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:CurrentUser">
    <ns3:CurrentUser>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:CurrentUser/ns3:FileAs">
    <ns3:FileAs>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
  ...
  <xsl:template match="/ns3:Company/ns3:Address2Street">
    <ns3:Address2Street>
      <xsl:for-each select="@ns3:*|@*[namespace-uri()='''']">
        <xsl:attribute name="{name()}" namespace="{namespace-uri()}">
          <xsl:value-of select="." />
